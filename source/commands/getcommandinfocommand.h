...
public:
	GetCommandInfoCommand(Settings& settings, string option);
	GetCommandInfoCommand(Settings& settings) : Command(settings) { abort = true; calledHelp = true; setParameters(); }
