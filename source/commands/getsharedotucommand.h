...
public:
	...
	GetSharedOTUCommand(Settings& settings, string option);
	GetSharedOTUCommand(Settings& settings);
	~GetSharedOTUCommand() {}

	vector<string> setParameters();
	string getCommandName() { return "get.sharedseqs"; }
	string getCommandCategory() { return "OTU-Based Approaches"; }
	string getRequiredCommand(Settings& settings) : Command(settings) { return "none"; }
