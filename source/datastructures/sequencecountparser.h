...
public:
	SequenceCountParser(string, string);			//count, fasta - file mismatches will set ctrlc_pressed = true
	SequenceCountParser(string, CountTable&);		//fasta, counttable - file mismatches will set ctrlc_pressed = true
