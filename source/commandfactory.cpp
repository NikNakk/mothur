...
Command* CommandFactory::getCommand(string commandName, string optionString) {
	try {
        ...
        if(commandName == "biom.info")				{	return command = new BiomInfoCommand(optionString);                }
...
Command* CommandFactory::getCommand(string commandName, string optionString, string mode) {
	try {
		...
		else if((commandName == "count.seqs") || (commandName == "make.table"))			{	return pipecommand = new CountSeqsCommand(optionString);				}
        ...
        if(commandName == "biom.info")             {	return pipecommand = new BiomInfoCommand(optionString);                }
...
Command* CommandFactory::getCommand(string commandName) {
	try {
        ...
        if(commandName == "biom.info")             {	return shellcommand = new BiomInfoCommand();               }
