...
public:
	...
	Chimera() : length(0), unaligned(false), byGroup(false) {}
	virtual ~Chimera() {	};
	...
	virtual Sequence print(ostream&, ostream&) { return Sequence(); }
	virtual Sequence print(ostream&, ostream&, data_results, data_results) { return Sequence(); }
	virtual int print(ostream&, ostream&, string) { return 0; }
	virtual int getNumNoParents() { return 0; }
	virtual data_results getResults() { return data_results(); }
