...
class TaxonomyFileParameter : public InputTypeParameter {
public:
	TaxonomyFileParameter(std::string& countfile, Settings& settings, std::string name, bool required, bool important = false,
