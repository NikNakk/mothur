...
class ContigsReportFileParameter : public InputTypeParameter {
public:
	ContigsReportFileParameter(std::string& countfile, Settings& settings, std::string name, bool required, bool important = false,
