...
class AlignReportFileParameter : public InputTypeParameter {
public:
	AlignReportFileParameter(std::string& countfile, Settings& settings, std::string name, bool required, bool important = false,
