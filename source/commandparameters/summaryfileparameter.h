...
class SummaryFileParameter : public InputTypeParameter {
public:
	SummaryFileParameter(std::string& countfile, Settings& settings, std::string name, bool required, bool important = false,
